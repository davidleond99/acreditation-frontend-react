...
interface IPageServerError {
  error?: string;
}
export const PageServerError: FC<IPageServerError> = ({ error }) => {
  useEffect(() => {
    window.location.replace('/');
  }, []);

  return (
    <div className="scalein animation-duration-500 align-items-center justify-content-center flex bg-white w-full h-full absolute">
      <svg
      ...
      <div className="ml-3">
        <h1 className="error-title flex w-full">Algo salió mal 😓</h1>
